                    ...
                    <div className="flex lg:flex-row flex-col-reverse justify-around">
                        <div className="laptop lg:w-[50%]">
                            ...
                            <div className="tut-content mt-2 flex flex-col items-left gap-[1.2rem] mx-3 lg:mx-7">
                                <img src="src\assets\img\desktop.png" alt="Desktop" className='rounded-lg invert' />
                                <img src="src\assets\img\continue.png" alt="Continue" className='rounded-lg' />
                                <h3 className='line flex items-center text-left text-[27px]'>Click Continue</h3>
                                <img src="src\assets\img\request.png" alt="" className="rounded-lg" />
                                <p className='line text-left text-[22px]'>Press 'Request A Download'</p>
                                <img src="src\assets\img\complete.png" alt="complete" className="rounded-lg" />
                                <p className='line text-left text-[22px]'>Complete Copy</p>
                                <img src="src\assets\img\options.png" alt="options" className="rounded-lg w-max" />
                                <img src="src\assets\img\format.png" alt="format" className='rounded-lg' />
