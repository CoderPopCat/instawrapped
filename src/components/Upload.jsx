                    ...
                    {!result && (
                        <>
                            ...
                            <div className="home-buttons mt-[2vh] flex justify-center items-center gap-[1rem]">
                                ...
                                <a data-tooltip-id='donate' data-tooltip-content='Consider donating if you liked this project ;)' data-tooltip-float={false} data-tooltip-variant='dark' href="https://ko-fi.com/popcatdev" target='_blank' className="pill-button bg-[#ffffff0d] p-[0.7rem] px-5 hover:bg-[#1b1f23] border-[2px] border-[#1b1f23] rounded-[3rem]"><span className="btn-text text-gray-300"><i className="text-gray-300 text-lg fas mr-2 fa-dollar"></i>Donate</span></a>
                            </div>
                        </>
                    )}
